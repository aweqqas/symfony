window.Modernizr = function(e, t, n) {
    ...
    !L(T, "undefined") && !L(T.call, "undefined") ? N = function(e, t) {
        ...
        var e;
        return x(["#", u, "{font:0/0 a}#", u, ':after{content:"', c, '";visibility:hidden;font:3px/1 a}'].join(""), function(t) {
            e = t.offsetHeight >= 3
        }), e
    };
    ...
    function(e, t) {
        ...
        e.html5 = y, g(t)
    }(this, t), i._version = r, i._prefixes = p, i._domPrefixes = m, i._cssomPrefixes = v, i.testProp = function(e) {
        return O([e])
...
function(e, t, n) {
...
}), Modernizr.addTest("webkitlineclamp", function() {
    return typeof window.document.createElement("div").style.webkitLineClamp != "undefined"
    ...
    for (var n in t)
        if (e.style[n] !== undefined) return !0;
    return !1
}), Modernizr.addTest("ie", function() {
    return /MSIE/.test(navigator.userAgent)
});
var Gum = Gum ? Gum : {};
Gum.ComponentManager = {}, Gum.Components = {}, Gum.components = {}, Gum.native = {}, Gum.domReady = !1, Gum.breakpoints = [{
    tshirt: "xs",
    min: 0,
    max: 479,
    adsense: "responsive320"
}, {
    tshirt: "s",
    min: 480,
    max: 766,
    adsense: "responsive481"
}, {
    tshirt: "m",
    min: 767,
    max: 1023,
    adsense: "responsive768"
}, {
    tshirt: "l",
    min: 1024,
    max: 1279,
    adsense: "responsive1024"
}, {
    tshirt: "xl",
    min: 1280,
    max: 1348,
    adsense: "responsive1280"
}, {
    tshirt: "xxl",
    min: 1349,
    max: Infinity,
    adsense: "responsive1349"
}], Gum.ads = {
    display: {
        base: {},
        slots: {},
